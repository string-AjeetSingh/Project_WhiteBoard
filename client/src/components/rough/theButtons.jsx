...
const SpecialButton = ({ theName }) => {
    ...
    return (
        <motion.button
            className="relative z-20 border-2 px-14 py-3 h-fit text-blue-300 dark:text-darkPanle  text-3xl rounded-xl overflow-hidden m-3
            ...
            onMouseLeave={() => !touched && setHovered(false)}
            onTouchStart={() => {
                setTouched(true);
                setHovered(true);
            }}
